...
const CLASS_ID = Components.ID("8e15c5d0-0f77-11de-8c30-0800200c9a66");
const CLASS_NAME = "Listens for measurements and acquires location using the Skyhook protocol";
const CONTRACT_ID = "@geopriv.dreamhosters.com/skyhooklocationprovider;1";

// This is your constructor.
// You can do stuff here.
function SkyhookLocationProvider() {
	// you can cheat and use this
	// while testing without
	// writing your own interface
	this.wrappedJSObject = this;

	// Set up a re-usable Skyhook request object
...
SkyhookLocationProvider.prototype = {
	// for nsISupports
	...
	_skyhookReq: null,		// Skyhook request to be used to get measurements
	...
	_handleMeasurementRequest: function(request, response, parent) {
		...
		// Do a synchronous Skyhook request
		parent._skyhookReq.meas = meas;
		var loc = parent._skyhookReq.send();
		if (!loc) {
...
//
// Factory
var SkyhookLocationProviderFactory = {
	createInstance: function (aOuter, aIID)
	{
		if (aOuter != null)
			throw Components.results.NS_ERROR_NO_AGGREGATION;
		return (new SkyhookLocationProvider()).QueryInterface(aIID);
	}
};

// Module
var SkyhookLocationProviderModule = {
	...
	getClassObject: function(aCompMgr, aCID, aIID)
	{
		...
		if (aCID.equals(CLASS_ID))
			return SkyhookLocationProviderFactory;
...
function NSGetModule(aCompMgr, aFileSpec) { return SkyhookLocationProviderModule; }
