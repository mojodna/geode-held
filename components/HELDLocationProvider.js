...
const CLASS_ID = Components.ID("dd1f372f-f199-47ba-8a34-62b6223d2192");
const CLASS_NAME = "Listens for measurements and acquires location using the HELD protocol";
const CONTRACT_ID = "@geopriv.dreamhosters.com/heldlocationprovider;1";

// This is your constructor.
// You can do stuff here.
function HELDLocationProvider() {
	// you can cheat and use this
	// while testing without
	// writing your own interface
	this.wrappedJSObject = this;

	// Set up a re-usable HELD request object
	this._heldReq = this._makeNewHELDRequest();
}

// This is the implementation of your component.
HELDLocationProvider.prototype = {
	// for nsISupports
	...
	_heldURI: "http://geopriv.dreamhosters.com/cgi-bin/lis.pl",		// HELD server to which we'll send requests 
	_heldReq: null,		// HELD request to be used to get measurements
	...
	_makeNewHELDRequest : function() {
		return new HELDLocationRequest(
			...
			null,
			function(code, text) {
				this._log("Error: code=["+code+"] text=["+text+"]");
			}
		);
	},
	...
	_handleMeasurementRequest: function(request, response, parent) {
		...
		// Do a synchronous HELD request
		parent._heldReq.meas = meas;
		var loc = parent._heldReq.send();
		if (!loc) {
...
//
// Factory
var HELDLocationProviderFactory = {
	createInstance: function (aOuter, aIID)
	{
		if (aOuter != null)
			throw Components.results.NS_ERROR_NO_AGGREGATION;
		return (new HELDLocationProvider()).QueryInterface(aIID);
	}
};

// Module
var HELDLocationProviderModule = {
	...
	getClassObject: function(aCompMgr, aCID, aIID)
	{
		...
		if (aCID.equals(CLASS_ID))
			return HELDLocationProviderFactory;
...
function NSGetModule(aCompMgr, aFileSpec) { return HELDLocationProviderModule; }
...
Geodetic.prototype = {
    ...
    fuzz: function(size, seed)
    {
        return this.shape.fuzz(size, seed);
    },
...
// {
//	geodetic: Geodetic (wraps a PidfShape; see above and below)
//	civic:	Civic (see above)
// 	method: DOMString 
//	rules: UsageRules (see above)
//	timestamp: Date
// }
...
Location.prototype = {
    ...
    // Translates from Skyhook to PIDF-LO, then calls Location(PIDF-LO)
...
PidfShape.prototype.fuzz = function(size, seed)
{
	...
	// If we've already got enough uncertainty, then we don't need to do anything
	return this;
    }
